...
[Service]
Environment="http_proxy=http://cache-st.ctu.edu.vn:3128"
Environment="https_proxy=http://cache-st.ctu.edu.vn:3128"
Environment="ftp_proxy=http://cache-st.ctu.edu.vn:3128"
EOF
